...
<div class="products">
    ...
    <a href="my_product.php?product_id=6" style="text-decoration:none">
    ...
    <a href="my_product.php?product_id=7" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                        if(!empty($user_id)) {
                            echo "?user_id=" . $user_id . "";
    ...
    <a href="my_product.php?product_id=8" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                        if(!empty($user_id)) {
                            echo "?user_id=" . $user_id . "";
    ...
    <a href="my_product.php?product_id=9" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                        if(!empty($user_id)) {
                            echo "?user_id=" . $user_id . "";
    ...
    <a href="my_product.php?product_id=10" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                        if(!empty($user_id)) {
                            echo "?user_id=" . $user_id . "";

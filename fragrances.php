...
<form method="post">
    ...
    <a href="my_product.php?product_id=11" style="text-decoration:none">
        ...
        <a href="my_product.php?product_id=12" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                    if(!empty($user_id)) {
                        echo "?user_id=" . $user_id . "";
        ...
        <a href="my_product.php?product_id=13" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                    if(!empty($user_id)) {
                        echo "?user_id=" . $user_id . "";
        ...
        <a href="my_product.php?product_id=14" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                    if(!empty($user_id)) {
                        echo "?user_id=" . $user_id . "";
        ...
        <a href="my_product.php?product_id=15" style="text-decoration:none">
            <div class="product-box">
                <form action="add_cart.php<?php
                    if(!empty($user_id)) {
                        echo "?user_id=" . $user_id . "";
